...
app.config['MAIL_USERNAME'] = 'healthcarewebappunderdb@outlook.com'
app.config['MAIL_PASSWORD'] = 'Healthcare@2023'
app.config['MAIL_DEFAULT_SENDER'] = 'healthcarewebappunderdb@outlook.com'
